...
\declaretheoremstyle[
    headfont=\bfseries\color{NavyBlue!80!black}, bodyfont=\normalfont,
    numbered=no,
    mdframed={
        linewidth=2pt,
        rightline=false, topline=false, bottomline=false,
...
\declaretheorem[style=thmblueline, name=Khẳng định]{claim}

\declaretheorem[style=thmalgorithmbox, name=Thuật toán]{algorithm}
